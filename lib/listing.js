...
module.exports = {
  ...
  contractDate: {type:'date', desc: desc.contractDate},
  ...
  disclosures: {type:'array', subtype: 'string', desc: desc.disclosures},
  ...
  termsOfSale: {type:'array', subtype: 'string', desc: desc.termsOfSale},
  ...
  appliances: {type:'array', subtype: 'string', desc: desc.appliances},
  telephoneService: {type:'array', subtype: 'string', desc: desc.telephoneService},
  view: {type:'array', subtype: 'string', desc: desc.view},
  waterfront: {type:'boolean', desc: desc.waterfront},
  waterSource: {type:'array', subtype: 'string', desc: desc.waterSource},
  ...
  fireplaceFeatures: {type:'array', subtype: 'string', desc: desc.fireplaceFeatures},
  exteriorFeatures: {type:'array', subtype: 'string', desc: desc.exteriorFeatures},
  flooring: {type:'array', subtype: 'string', desc: desc.flooring},
  foundationDetails: {type:'array', subtype: 'string', desc: desc.foundationDetails},
  frontageLength: {type:'number', desc: desc.frontageLength},
  gas: {type:'array', subtype: 'string', desc: desc.gas},
  accessibilityFeatures: {type:'array', subtype: 'string', desc: desc.accessibilityFeatures},
  cooling: {type:'array', subtype: 'string', desc: desc.cooling},
  heating: {type:'array', subtype: 'string', desc: desc.heating},
  ...
  poolFeatures: {type:'array', subtype: 'string', desc: desc.poolFeatures},
  poolPrivate: {type:'boolean', desc: desc.poolPrivate},
  possession: {type:'array', subtype: 'string', desc: desc.possession},
  roadSurface: {type:'array', subtype: 'string', desc: desc.roadSurface},
  roof: {type:'string', desc: desc.roof},
  constructionMaterials: {type:'array', subtype: 'string', desc: desc.constructionMaterials},
  sewer: {type:'array', subtype: 'string', desc: desc.sewer},
  ...
  laundry: {type:'array', subtype: 'string', desc: desc.laundry},
  ...
  taxYear: {type:'number', desc: desc.taxYear},
  taxStatus: {type:'array', subtype:'string', desc: desc.taxStatus}
